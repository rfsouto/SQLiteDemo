...
namespace SQLiteDemo
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            {
                using (var statement = connection.Prepare(@"CREATE TABLE IF NOT EXISTS Personas (
                ...
                using (var statement = connection.Prepare(@"INSERT INTO Personas (Nombre, Apellido)
                                            VALUES(@Nombre, @Apellido);"))
                {
                    statement.Bind("@Nombre", "Lionel");
                    statement.Bind("@Apellido", "Messi");
                    ...
                    statement.Bind("@Nombre", "Cristiano");
                    statement.Bind("@Apellido", "Ronaldo");
